...
import io.deus.wallet.core.adapters.BitcoinFeeInfo
import io.deus.wallet.core.adapters.zcash.ZcashAdapter
import io.deus.wallet.core.managers.ActiveAccountState
import io.deus.wallet.core.managers.Bep2TokenInfoService
import io.deus.wallet.core.managers.EvmKitWrapper
import io.deus.wallet.core.providers.FeeRates
...
import io.deus.wallet.entities.SyncMode
...
import io.deus.wallet.modules.settings.appearance.AppIcon
import io.deus.wallet.modules.settings.security.autolock.AutoLockInterval
...
interface IEvmNodeSyncStorage {
    fun getSyncRecords(chainId: Int): List<EvmNodeSyncRecord>
    fun save(syncRecord: EvmNodeSyncRecord)
...
interface IEvmNodeSyncManager {
    fun onAppLaunch()
    fun getNodes(chainId: Int): List<String>
}
